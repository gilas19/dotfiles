...
alias brewup="brew update && brew upgrade && brew cleanup --prune=all && brew autoremove && brew doctor && brew bundle dump --force"
...
alias yadmup="yadm pull && yadm commit -a -m 'Update dotfiles' && yadm push"